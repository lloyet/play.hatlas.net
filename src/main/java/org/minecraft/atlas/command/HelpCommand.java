...
public class HelpCommand {
    ...
    private static Component buildJobHelp() {
        return Component.text("--- Job Commands ---", NamedTextColor.GOLD)
                ...
                .append(entry("/job info", "View your job, level, XP, and all XP sources with ACTIVE/LOCKED/EXPIRED status"))
                .append(entry("/job level", "Quick view of your current level and XP bar"))
